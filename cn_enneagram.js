...
function getetext(type) {
    ...
    if (type == 'Sp3') {
        return ["关键词:安全感", "虚荣之罪", "3号是与自身的围绕价值评价的心区隔离的类型，也就是不在乎自己内心对自己的评价，而极度迎合讨好他人的评价的类型，为此其在社会竞争中往往会不择手段的去竞争获得优胜，获取虚名，因此其被定义为七原罪之外的虚荣。"]
    }
    if (type == 'So4') {

...
function CheckEnneagrama(Instincts, num) {
    ...
    if (num == 4) {
        if (Instincts == 'Sp' || Instincts == 'Sx') {
            return ['我对于和他人欢乐的情感互动(贴贴)不会感到恶心，而且觉得和他人友好互动可以提高他人对我的评价',[{ text: "符合", type: [3, 4], value: 20, color: "yes" },{ text: "不符合", type: [4, ''], value: 3, color: "no" }]]
        }
        if (Instincts == 'So') {
            return ['我对于和他人欢乐的情感互动(贴贴)不会感到恶心，不过也不喜欢向人诉苦或表达悲伤的情绪，担忧那样会让他人对我留下不好的印象',[{ text: "符合", type: [3, 4], value: 20, color: "yes" },{ text: "不符合", type: [4, ''], value: 4, color: "no" }]]
        }
    }
    if (num == 5) {
        if (Instincts == 'So' || Instincts == 'Sx') {
...
function getetext(type) {
    if (type == 'So1') {
        return ["关键词:不适感", "憤怒之罪", "1号的侧翼是9和1，所以可能会表现出9或1表面特征，如果表现出9的特征过于明显则称为1w9,同理，2的特征过于明显则称为1w2，1号的整合解离方向是7和4，所以1号可能表现出向4和7变化的特征。1号号作为围绕自身欲望和存在感的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。So1即1号社群型认为自己已经达到完美状态，所以经常会采取一种完美无可挑剔的状态，并且认为【我是对的，你是错的】，不会愿意去适应对方的做法和腔调。"]
    }
    if (type == 'Sx1') {
        return ["关键词:热忱", "憤怒之罪", "1号的侧翼是9和1，所以可能会表现出9或1表面特征，如果表现出9的特征过于明显则称为1w9,同理，2的特征过于明显则称为1w2，1号的整合解离方向是7和4，所以1号可能表现出向4和7变化的特征。1号号作为围绕自身欲望和存在感的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。1sx即愤怒与性本能结合的1号性本能型，我们可能会认为1号性本能型的特点是欲望特别强烈，并进而导致他们急迫、易恐。如果想了解为什么性领域的愤怒会引发热仇，那么可以说是因为欲望从锁怒中得到了侵略性、 攻击性，从而使自身得到加强。换句话说，馈怒赋予欲望一种特殊的力量或者说紧张感，使得人不仅感到自己被拉向满足欲望的方向，而且觉得理直气壮。结果便是造成有些人会具有强烈的精神意志力和征服欲。我用下面这个集体行为的例子来加以解释：当南非翡翠和钻石矿石的开采被欧洲人垄断时，许多人提出反对，认为这些财富属于非洲人。但是一些人反问道（他们对此深信不疑）：“放到他们手里有什么好处？他们又没有文化！”在他们看来，既然欧洲人是文明人，而非洲人则被认为是原始的野蛮人，钻石自然应该属于欧洲人。"]
    }
    if (type == 'Sp1') {
        return ["关键词:担忧", "憤怒之罪", "1号的侧翼是9和1，所以可能会表现出9或1表面特征，如果表现出9的特征过于明显则称为1w9,同理，2的特征过于明显则称为1w2，1号的整合解离方向是7和4，所以1号可能表现出向4和7变化的特征。1号号作为围绕自身欲望和存在感的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。Sp代表着自保的本能，追求完美的愤怒的能量与审视自身的自保的本能结合后，当其在自己心目中的形象太不完美时，他的愤怒常常会转化成一种持续的自我改进的能量，就好像上了瘾一样。并且他的愤怒，会隐藏在与其愤怒和埋怨截然相反的彬彬有礼的善行和乐于助人的态度背后。换言之，他将愤怒转换成了善意。"]
    }
    if (type == 'So2') {
    ...
    if (type == 'So8') {
        return ["关键词:同盟", "纵欲之罪", "8号的侧翼是7和9，所以可能会表现出7或9的表面特征，如果表现出7的特征过于明显则称为8w7,同理，9的特征过于明显则称为8w9，8号的整合解离方向是5和2，所以8号可能表现出向5和1变化的特征。8号作为围绕自身欲望和存在感的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。8号社群型是一种叛逆者，他们愤世嫉俗，简单粗暴，坚韧而又粗鲁，友谊和同盟是他们的核心议题，与朋友同生共死打倒强权共赴胜利是他们最为渴望的事情。"]
    }
    if (type == 'Sx8') {
        return ["关键词:占有欲", "纵欲之罪", "8号的侧翼是7和9，所以可能会表现出7或9的表面特征，如果表现出7的特征过于明显则称为8w7,同理，9的特征过于明显则称为8w9，8号的整合解离方向是5和2，所以8号可能表现出向5和1变化的特征。8号作为围绕自身欲望和存在感的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。Sx8即8号性本能型是所有类型中最为叛逆的最为反社会的类型，他们有着极强的占有欲和吸引力，这种占有欲并非对某种物品，而是对他人的占有欲，对场面的占有欲，渴望把整个场面的注意力都吸引到自己身上来。"]
    }
    if (type == 'Sp8') {
        return ["关键词:满足感", "纵欲之罪", "8号的侧翼是7和9，所以可能会表现出7或9的表面特征，如果表现出7的特征过于明显则称为8w7,同理，9的特征过于明显则称为8w9，8号的整合解离方向是5和2，所以8号可能表现出向5和1变化的特征。8号作为围绕自身欲望和存在感的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。Sp8即8号自保型，是所有8中最会隐藏自己散发出的反社会气息，他们是最能在历史剧变中生存下来的类型，他们很容易认同【善良和良好的意图根本不存在】，他们会像社会主义者一样向他人慷慨的提供保护，但真正目的是借此控制和奴役他人，使他人无法威胁到他们自身。"]
    }
    if (type == 'So9') {
        return ["关键词:参与/归属", "怠惰之罪", "9号的侧翼是8和1，所以可能会表现出8或1的表面特征，如果表现出8的特征过于明显则称为9w8,同理，1的特征过于明显则称为9w1，9号的整合解离方向是3和6，所以9号可能表现出向3和6变化的特征。9号作为围绕自身欲望和存在感的腹区能量隔离的类型，可能会看似有着很强烈的理想的表现，实则只是从他人那里借来的理想，9号在灵性上是迟钝的，可能日复一日的做着相同的事不求改变，虽然他们可能会不求回报的服务于他人，但这根本上是一种灵性上的怠惰，因此被赋予了七原罪的怠惰之名。由于社群本能与腹区能量相冲突，形成作为反9的So9即社群9，与9号的怠惰原罪相反，So9是最为勤奋的类型，由于他们非常渴望融入群体，又因为灵性上的怠惰不容易感知到自身已经融入群体，所以他们经常会表现的积极奉献，勤奋工作，成为一个工作狂为争取集体的认可。"]
    }
    if (type == 'Sx9') {
        return ["关键词:共生", "怠惰之罪", "9号的侧翼是8和1，所以可能会表现出8或1的表面特征，如果表现出8的特征过于明显则称为9w8,同理，1的特征过于明显则称为9w1，9号的整合解离方向是3和6，所以9号可能表现出向3和6变化的特征。9号作为围绕自身欲望和存在感的腹区能量隔离的类型，可能会看似有着很强烈的理想的表现，实则只是从他人那里借来的理想，9号在灵性上是迟钝的，可能日复一日的做着相同的事不求改变，虽然他们可能会不求回报的服务于他人，但这根本上是一种灵性上的怠惰，因此被赋予了七原罪的怠惰之名。Sx9即性本能9通过与他人融合共生体验存在感，他们可能极度的违背了自己的需求去满足自己的融合对象的需求，甚至自己已经饱受摧残仍然注意不到自身的需求。"]
    }
    if (type == 'Sp9') {
        return ["关键词:食欲", "怠惰之罪", "9号的侧翼是8和1，所以可能会表现出8或1的表面特征，如果表现出8的特征过于明显则称为9w8,同理，1的特征过于明显则称为9w1，9号的整合解离方向是3和6，所以9号可能表现出向3和6变化的特征。9号作为围绕自身欲望和存在感的腹区能量隔离的类型，可能会看似有着很强烈的理想的表现，实则只是从他人那里借来的理想，9号在灵性上是迟钝的，可能日复一日的做着相同的事不求改变，虽然他们可能会不求回报的服务于他人，但这根本上是一种灵性上的怠惰，因此被赋予了七原罪的怠惰之名。Sp9即自保型9，是最为接近9号的怠惰的字面意义的9，【我吃，故我在】这句话很好的表现了Sp9的特点，他们可以日复一日的沉浸在一成不变的吃喝拉撒睡中不去谋求改变，就像一个躺在沙发上毫无兴致的看着索然无味的电视节目而不会想着切换频道。"]
    }
    return [" ", " ", " "]
}
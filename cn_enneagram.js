...
function TestEnneagramq(Instincts,num) {
    ...
    if (num == 8) {
        ...
        if (Instincts == 'Sp') {
            return '我倾向压低自己的欲望以获得更多个人独处的时间，因为欲望意味着需要去依赖他人，我倾向摆脱和他人的情感交流，退缩到自己头脑中的内心世界中最为舒适'
        }
    }
    if (num == 9) {
        if (Instincts == 'So') {
        ...
        if (Instincts == 'Sp') {
            return '我渴望得到我所认可亲近的人的保护，渴望一个小小的，温暖舒适的世界'
        }
    }
    if (num == 10) {
        if (Instincts == 'So') {
...
function getecharacter(type) {
    ...
    if (type == 'So9') {
        return [["阿尔托莉雅","我将会带领我的人民，战斗到最后一刻","<img src='./img/Si-T/02.png' alt='01 pic'>"]]
    }
    if (type == 'Sx9') {
        return [["休比","这份思念，这颗心，从机械中孕育出来 得到了生命 这全部都赌在这251秒里！","<img src='./img/Si-F/01.png' alt='01 pic'>"]]
    }
    if (type == 'Sp9') {
...
function getetext(type) {
    if (type == 'So1') {
        return ["关键词:不适感","憤怒之罪","1号的愤怒不是指常规意义上的愤怒，而是一种源自内心的驱动力量。"]
    }
    if (type == 'Sx1') {
        return ["关键词:热忱","憤怒之罪","1号的愤怒不是指常规意义上的愤怒，而是一种源自内心的驱动力量。我们可能会认为1号性本能型的特点是欲望特别强烈，并进而导致他们急迫、易恐。如果想了解为什么性领域的愤怒会引发热仇，那么可以说是因为欲望从锁怒中得到了侵略性、 攻击性，从而使自身得到加强。换句话说，馈怒赋予欲望一种特殊的力量或者说紧张感，使得人不仅感到自己被拉向满足欲望的方向，而且觉得理直气壮。结果便是造成有些人会具有强烈的精神意志力和征服欲。我用下面这个集体行为的例子来加以解释：当南非翡翠和钻石矿石的开采被欧洲人垄断时，许多人提出反对，认为这些财富属于非洲人。但是一些人反问道（他们对此深信不疑）：“放到他们手里有什么好处？他们又没有文化！”在他们看来，既然欧洲人是文明人，而非洲人则被认为是原始的野蛮人，钻石自然应该属于欧洲人。"]
    }
    if (type == 'Sp1') {
        return ["关键词:担忧","憤怒之罪","1号的愤怒不是指常规意义上的愤怒，而是一种源自内心的驱动力量。在现实生活中，当一个人在自己心目中的形象太不完美时，他的行为常常会转化成一种持续的自我改进，就好像上了瘾一样。而他的愤怒，则隐藏在与其愤怒和埋怨截然相反的彬彬有礼的善行和乐于助人的态度背后。换言之，他将愤怒转换成了善意。"]
    }
    if (type == 'So2') {
        return ["关键词:野心","傲慢之罪","2号作为围绕价值评价的心区能量过剩的类型，内心非常自我中心给自己较高的评价，2号很愿意对他人释放善意，摆出友善关爱的态度，不过其核心动机是希望对方也能以同等的友好来回报他们，其心中认为自己做的很优秀，所有人都应该对其友好，因此2号被称为傲慢。 "]
    }
    if (type == 'Sx2') {
        return ["关键词:征服","傲慢之罪","2号作为围绕价值评价的心区能量过剩的类型，内心非常自我中心给自己较高的评价，2号很愿意对他人释放善意，摆出友善关爱的态度，不过其核心动机是希望对方也能以同等的友好来回报他们，其心中认为自己做的很优秀，所有人都应该对其友好，因此2号被称为傲慢。"]
    }
    if (type == 'Sp2') {
        return ["关键词:特权","傲慢之罪","2号作为围绕价值评价的心区能量过剩的类型，内心非常自我中心给自己较高的评价，2号很愿意对他人释放善意，摆出友善关爱的态度，不过其核心动机是希望对方也能以同等的友好来回报他们，其心中认为自己做的很优秀，所有人都应该对其友好，因此2号被称为傲慢。"]
    }                                                           
    if (type == 'So3') {
        return ["关键词:声誉","虚荣之罪"," "]
    }
    ...
    if (type == 'So4') {
        return ["关键词:羞耻","嫉妒之罪","4号作为围绕价值评价的心区能量缺乏的类型，其核心是认为自己不如他人，所以4号的嫉妒是与他人的对比中感受到自身价值的缺失，从而容易陷入痛苦之中，为保护自身的情感远离他人。"]
    }
    if (type == 'Sx4') {
        return ["关键词:仇恨","嫉妒之罪","4号作为围绕价值评价的心区能量缺乏的类型，其核心是认为自己不如他人，所以4号的嫉妒是与他人的对比中感受到自身价值的缺失，从而容易陷入痛苦之中，为保护自身的情感远离他人。不过Sx4是拒绝嫉妒的反4，虽然他们深层意识里认为自己不如他人，但他们拒绝这一点，所以喜欢摆出远在他人之上的态度，并对某一类人充满仇恨。"]
    }
    if (type == 'Sp4') {
        return ["关键词:坚韧","嫉妒之罪","4号作为围绕价值评价的心区能量缺乏的类型，其核心是认为自己不如他人，所以4号的嫉妒是与他人的对比中感受到自身价值的缺失，从而容易陷入痛苦之中，为保护自身的情感远离他人。"]
    }
    if (type == 'So5') {
        return ["关键词:图腾","贪婪之罪","5号作为围绕思维和安全需求的脑区能量过剩的类型，非常容易沉浸到思维世界之中，所以5号的贪婪指的是5号容易贪婪的汲取某一领域的事物提升自己的思维和能力以应对可能潜在的危险与安全焦虑，例如贪婪的汲取时间，知识，信息等，并且可能为此不惜牺牲其他方面的需求，节衣缩食过着低欲望的远离他人的简朴生活，不惜代价的追求某一件事物才是真正的贪婪。"]
    }
    if (type == 'Sx5') {
        return ["关键词:秘密","贪婪之罪","5号作为围绕思维和安全需求的脑区能量过剩的类型，非常容易沉浸到思维世界之中，所以5号的贪婪指的是5号容易贪婪的汲取某一领域的事物提升自己的思维和能力以应对可能潜在的危险与安全焦虑，例如贪婪的汲取时间，知识，信息等，并且可能为此不惜牺牲其他方面的需求，节衣缩食过着低欲望的远离他人的简朴生活，不惜代价的追求某一件事物才是真正的贪婪。不过Sx5是反5，其并非像一般的5号那样因为贪婪而退缩，Sx渴望着激烈深入的体验，尽管拒绝远离他人，但内心深处渴望着一个极度理想的伴侣"]
    }
    if (type == 'Sp5') {
        return ["关键词:避难所","贪婪之罪","5号作为围绕思维和安全需求的脑区能量过剩的类型，非常容易沉浸到思维世界之中，所以5号的贪婪指的是5号容易贪婪的汲取某一领域的事物提升自己的思维和能力以应对可能潜在的危险与安全焦虑，例如贪婪的汲取时间，知识，信息等，并且可能为此不惜牺牲其他方面的需求，节衣缩食过着低欲望的远离他人的简朴生活，不惜代价的追求某一件事物才是真正的贪婪。"]
    }
    if (type == 'So6') {
        return ["关键词:责任","恐惧之罪"," "]
    }

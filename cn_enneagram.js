    ...
    if (Instincts == 'Sp') {
        if (num == 0) {
            result = [
                ...
                { text: "我更重视自身价值认同和自我认可，我希望在与他人的竞争中获胜，取得社会成就，提升社会地位。", type: [3, ""], value: 16, color: "Instincts_answer" },
    ...
    if (num == 1) {
        ...
        if (Instincts == 'Sp') {
            result = [
                ...
                { text: "我很在乎他人对我的看法，所以尽可能把自己做到最好。", type: [3, ""], value: 10, color: "Ired_answer" },
                { text: "我不怎么在乎他人的评价，也认为自己不如他人，我更愿意尽可能一个人独自承受痛苦，羞于启齿寻求他人的关爱。", type: [4, ""], value: 10, color: "Ired_answer" },
                { text: "我觉得以上描述都有部分符合，很难选择。", type: [3, ""], value: 6, color: "Ired_answer" },
            ]
        }
    }
...
function getetext(type) {
    if (type == 'So1') {
        return ["关键词:不适感", "憤怒之罪", "1号的侧翼是9和1，所以可能会表现出9或1表面特征，如果表现出9的特征过于明显则称为1w9,同理，2的特征过于明显则称为1w2，1号的整合解离方向是7和4，所以1号可能表现出向4和7变化的特征。1号号作为围绕自身欲望和生存模式的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。"]
    }
    if (type == 'Sx1') {
        return ["关键词:热忱", "憤怒之罪", "1号的侧翼是9和1，所以可能会表现出9或1表面特征，如果表现出9的特征过于明显则称为1w9,同理，2的特征过于明显则称为1w2，1号的整合解离方向是7和4，所以1号可能表现出向4和7变化的特征。1号号作为围绕自身欲望和生存模式的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。1sx即愤怒与性本能结合的1号性本能型，我们可能会认为1号性本能型的特点是欲望特别强烈，并进而导致他们急迫、易恐。如果想了解为什么性领域的愤怒会引发热仇，那么可以说是因为欲望从锁怒中得到了侵略性、 攻击性，从而使自身得到加强。换句话说，馈怒赋予欲望一种特殊的力量或者说紧张感，使得人不仅感到自己被拉向满足欲望的方向，而且觉得理直气壮。结果便是造成有些人会具有强烈的精神意志力和征服欲。我用下面这个集体行为的例子来加以解释：当南非翡翠和钻石矿石的开采被欧洲人垄断时，许多人提出反对，认为这些财富属于非洲人。但是一些人反问道（他们对此深信不疑）：“放到他们手里有什么好处？他们又没有文化！”在他们看来，既然欧洲人是文明人，而非洲人则被认为是原始的野蛮人，钻石自然应该属于欧洲人。"]
    }
    if (type == 'Sp1') {
        return ["关键词:担忧", "憤怒之罪", "1号的侧翼是9和1，所以可能会表现出9或1表面特征，如果表现出9的特征过于明显则称为1w9,同理，2的特征过于明显则称为1w2，1号的整合解离方向是7和4，所以1号可能表现出向4和7变化的特征。1号号作为围绕自身欲望和生存模式的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。Sp代表着自保的本能，追求完美的愤怒的能量与审视自身的自保的本能结合后，当其在自己心目中的形象太不完美时，他的愤怒常常会转化成一种持续的自我改进的能量，就好像上了瘾一样。并且他的愤怒，会隐藏在与其愤怒和埋怨截然相反的彬彬有礼的善行和乐于助人的态度背后。换言之，他将愤怒转换成了善意。"]
    }
    if (type == 'So2') {
        return ["关键词:野心", "傲慢之罪", "2号的侧翼是1和3，所以可能会表现出1或3表面特征，如果表现出1的特征过于明显则称为2w1,同理，3的特征过于明显则称为2w3，2号的整合解离方向是8和4，所以2号可能表现出向4和8变化的特征。2号作为围绕价值评价的心区能量过剩的类型，内心非常自我中心给自己较高的评价，2号很愿意对他人释放善意，摆出友善关爱的态度，不过其核心动机是希望对方也能以同等的友好来回报他们，其心中认为自己做的很优秀，所有人都应该对其友好，因此2号被称为傲慢。 "]
    }
    if (type == 'Sx2') {
        return ["关键词:征服", "傲慢之罪", "2号的侧翼是1和3，所以可能会表现出1或3表面特征，如果表现出1的特征过于明显则称为2w1,同理，3的特征过于明显则称为2w3，2号的整合解离方向是8和4，所以2号可能表现出向4和8变化的特征。2号作为围绕价值评价的心区能量过剩的类型，内心非常自我中心给自己较高的评价，2号很愿意对他人释放善意，摆出友善关爱的态度，不过其核心动机是希望对方也能以同等的友好来回报他们，其心中认为自己做的很优秀，所有人都应该对其友好，因此2号被称为傲慢。"]
    }
    if (type == 'Sp2') {
        return ["关键词:特权", "傲慢之罪", "2号的侧翼是1和3，所以可能会表现出1或3表面特征，如果表现出1的特征过于明显则称为2w1,同理，3的特征过于明显则称为2w3，2号的整合解离方向是8和4，所以2号可能表现出向4和8变化的特征。2号作为围绕价值评价的心区能量过剩的类型，内心非常自我中心给自己较高的评价，2号很愿意对他人释放善意，摆出友善关爱的态度，不过其核心动机是希望对方也能以同等的友好来回报他们，其心中认为自己做的很优秀，所有人都应该对其友好，因此2号被称为傲慢。"]
    }
    if (type == 'So3') {
        return ["关键词:声誉", "虚荣之罪", "3号的侧翼是2和4，所以可能会表现出2或4的表面特征，如果表现出2的特征过于明显则称为3w2,同理，4的特征过于明显则称为3w4，2号的整合解离方向是9和6，所以3号可能表现出向9和6变化的特征。3号是与自身的围绕价值评价的心区隔离的类型，也就是不在乎自己内心对自己的评价，而极度迎合讨好他人的评价的类型，为此其在社会竞争中往往会不择手段的去竞争获得优胜，获取虚名，因此其被定义为七原罪之外的虚荣。 "]
    }
    if (type == 'Sx3') {
        return ["关键词:吸引力", "虚荣之罪", "3号的侧翼是2和4，所以可能会表现出2或4的表面特征，如果表现出2的特征过于明显则称为3w2,同理，4的特征过于明显则称为3w4，2号的整合解离方向是9和6，所以3号可能表现出向9和6变化的特征。3号是与自身的围绕价值评价的心区隔离的类型，也就是不在乎自己内心对自己的评价，而极度迎合讨好他人的评价的类型，为此其在社会竞争中往往会不择手段的去竞争获得优胜，获取虚名，因此其被定义为七原罪之外的虚荣。"]
    }
    if (type == 'Sp3') {
    ...
    if (type == 'So4') {
        return ["关键词:羞耻", "嫉妒之罪", "4号的侧翼是3和4，所以可能会表现出3或5的表面特征，如果表现出3的特征过于明显则称为4w3,同理，5的特征过于明显则称为4w5，4号的整合解离方向是2和1，所以4号可能表现出向2和1变化的特征。4号作为围绕价值评价的心区能量缺乏的类型，其核心是认为自己不如他人，所以4号的嫉妒是与他人的对比中感受到自身价值的缺失，从而容易陷入痛苦之中，为保护自身的情感远离他人。"]
    }
    if (type == 'Sx4') {
    ...
    if (type == 'So6') {
        return ["关键词:责任", "恐惧之罪", "6号的侧翼是5和7，所以可能会表现出5或7的表面特征，如果表现出5的特征过于明显则称为6w5,同理，7的特征过于明显则称为6w7，6号的整合解离方向是3和9，所以6号可能表现出向3和9变化的特征。6号作为围绕思维和安全需求的脑区隔离的类型，虽然有着丰富的思考，但与自己的脑区隔离，很难真正做到自己的思考，以基于某些前人或他人的理论或说法来进行思考，恐惧自身是错误的是邪恶的，希望确信自己是正义且正确的，往往他们会捍卫着主流的价值观或说法，因此容易被认为是非常理性的类型被误认为5号，他们内心有着捍卫他们所认可的价值观的激烈的情绪，又容易被误认为4号或8号，但548都是黑暗类型，而6号充满对光明与正义的追求，因为其恐惧黑暗，恐惧邪恶，恐惧错误，恐惧一切不正确的东西想通过依附于某一权威的羽翼之下得到保护放弃自身的思考来应对安全感的焦虑，所以其是七原罪之外衍生的恐惧。"]
    }
    if (type == 'Sx6') {
    ...
    if (type == 'Sp6') {
        return ["关键词:温暖", "恐惧之罪", "6号的侧翼是5和7，所以可能会表现出5或7的表面特征，如果表现出5的特征过于明显则称为6w5,同理，7的特征过于明显则称为6w7，6号的整合解离方向是3和9，所以6号可能表现出向3和9变化的特征。6号作为围绕思维和安全需求的脑区隔离的类型，虽然有着丰富的思考，但与自己的脑区隔离，很难真正做到自己的思考，以基于某些前人或他人的理论或说法来进行思考，恐惧自身是错误的是邪恶的，希望确信自己是正义且正确的，往往他们会捍卫着主流的价值观或说法，因此容易被认为是非常理性的类型被误认为5号，他们内心有着捍卫他们所认可的价值观的激烈的情绪，又容易被误认为4号或8号，但548都是黑暗类型，而6号充满对光明与正义的追求，因为其恐惧黑暗，恐惧邪恶，恐惧错误，恐惧一切不正确的东西，想通过依附于某一权威的羽翼之下得到保护放弃自身的思考来应对安全感的焦虑，所以其是七原罪之外衍生的恐惧。"]
    }
    if (type == 'So7') {
        return ["关键词:牺牲", "暴食之罪", "7号的侧翼是6和8，所以可能会表现出6或8的表面特征，如果表现出6的特征过于明显则称为7w6,同理，8的特征过于明显则称为7w8，7号的整合解离方向是5和1，所以7号可能表现出向5和1变化的特征。7号作为围绕思维和安全需求的脑区能量缺乏的类型，总是容易忽略安全感上的焦虑，狼吞虎咽般的追求着获取自身独特的愉悦，因此被赋予了七原罪之中的暴食。"]
    }
    if (type == 'Sx7') {
        return ["关键词:易受暗示", "暴食之罪", "7号的侧翼是6和8，所以可能会表现出6或8的表面特征，如果表现出6的特征过于明显则称为7w6,同理，8的特征过于明显则称为7w8，7号的整合解离方向是5和1，所以7号可能表现出向5和1变化的特征。7号作为围绕思维和安全需求的脑区能量缺乏的类型，总是容易忽略安全感上的焦虑，狼吞虎咽般的追求着获取自身独特的愉悦，因此被赋予了七原罪之中的暴食。"]
    }
    if (type == 'Sp7') {
        return ["关键词:家庭", "暴食之罪", "7号的侧翼是6和8，所以可能会表现出6或8的表面特征，如果表现出6的特征过于明显则称为7w6,同理，8的特征过于明显则称为7w8，7号的整合解离方向是5和1，所以7号可能表现出向5和1变化的特征。7号作为围绕思维和安全需求的脑区能量缺乏的类型，总是容易忽略安全感上的焦虑，狼吞虎咽般的追求着获取自身独特的愉悦，因此被赋予了七原罪之中的暴食。"]
    }
    if (type == 'So8') {
        return ["关键词:同盟", "纵欲之罪", "8号的侧翼是7和9，所以可能会表现出7或9的表面特征，如果表现出7的特征过于明显则称为8w7,同理，9的特征过于明显则称为8w9，8号的整合解离方向是5和2，所以8号可能表现出向5和1变化的特征。8号作为围绕自身欲望和生存模式的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。"]
    }
    if (type == 'Sx8') {
        return ["关键词:占有欲", "纵欲之罪", "8号的侧翼是7和9，所以可能会表现出7或9的表面特征，如果表现出7的特征过于明显则称为8w7,同理，9的特征过于明显则称为8w9，8号的整合解离方向是5和2，所以8号可能表现出向5和1变化的特征。8号作为围绕自身欲望和生存模式的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。"]
    }
    if (type == 'Sp8') {
        return ["关键词:满足感", "纵欲之罪", "8号的侧翼是7和9，所以可能会表现出7或9的表面特征，如果表现出7的特征过于明显则称为8w7,同理，9的特征过于明显则称为8w9，8号的整合解离方向是5和2，所以8号可能表现出向5和1变化的特征。8号作为围绕自身欲望和生存模式的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。"]
    }
    if (type == 'So9') {
        return ["关键词:参与/归属", "怠惰之罪", "9号的侧翼是8和1，所以可能会表现出8或1的表面特征，如果表现出8的特征过于明显则称为9w8,同理，1的特征过于明显则称为9w1，9号的整合解离方向是3和6，所以9号可能表现出向3和6变化的特征。9号作为围绕自身欲望和生存模式的腹区能量隔离的类型，可能会看似有着很强烈的理想的表现，实则只是从他人那里借来的理想，9号在灵性上是迟钝的，可能日复一日的做着相同的事不求改变，虽然他们可能会不求回报的服务于他人，但这根本上是一种灵性上的怠惰，因此被赋予了七原罪的怠惰之名。"]
    }
    if (type == 'Sx9') {
        return ["关键词:共生", "怠惰之罪", "9号的侧翼是8和1，所以可能会表现出8或1的表面特征，如果表现出8的特征过于明显则称为9w8,同理，1的特征过于明显则称为9w1，9号的整合解离方向是3和6，所以9号可能表现出向3和6变化的特征。9号作为围绕自身欲望和生存模式的腹区能量隔离的类型，可能会看似有着很强烈的理想的表现，实则只是从他人那里借来的理想，9号在灵性上是迟钝的，可能日复一日的做着相同的事不求改变，虽然他们可能会不求回报的服务于他人，但这根本上是一种灵性上的怠惰，因此被赋予了七原罪的怠惰之名。"]
    }
    if (type == 'Sp9') {
        return ["关键词:食欲", "怠惰之罪", "9号的侧翼是8和1，所以可能会表现出8或1的表面特征，如果表现出8的特征过于明显则称为9w8,同理，1的特征过于明显则称为9w1，9号的整合解离方向是3和6，所以9号可能表现出向3和6变化的特征。9号作为围绕自身欲望和生存模式的腹区能量隔离的类型，可能会看似有着很强烈的理想的表现，实则只是从他人那里借来的理想，9号在灵性上是迟钝的，可能日复一日的做着相同的事不求改变，虽然他们可能会不求回报的服务于他人，但这根本上是一种灵性上的怠惰，因此被赋予了七原罪的怠惰之名。"]
    }
    return [" ", " ", " "]
}
...
function getetext(type) {
    if (type == 'So1') {
        return ["关键词:不适感", "憤怒之罪", "1号号作为围绕自身欲望和生存模式的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。"]
    }
    if (type == 'Sx1') {
        return ["关键词:热忱", "憤怒之罪", "1号号作为围绕自身欲望和生存模式的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。1sx即愤怒与性本能结合的1号性本能型，我们可能会认为1号性本能型的特点是欲望特别强烈，并进而导致他们急迫、易恐。如果想了解为什么性领域的愤怒会引发热仇，那么可以说是因为欲望从锁怒中得到了侵略性、 攻击性，从而使自身得到加强。换句话说，馈怒赋予欲望一种特殊的力量或者说紧张感，使得人不仅感到自己被拉向满足欲望的方向，而且觉得理直气壮。结果便是造成有些人会具有强烈的精神意志力和征服欲。我用下面这个集体行为的例子来加以解释：当南非翡翠和钻石矿石的开采被欧洲人垄断时，许多人提出反对，认为这些财富属于非洲人。但是一些人反问道（他们对此深信不疑）：“放到他们手里有什么好处？他们又没有文化！”在他们看来，既然欧洲人是文明人，而非洲人则被认为是原始的野蛮人，钻石自然应该属于欧洲人。"]
    }
    if (type == 'Sp1') {
        return ["关键词:担忧", "憤怒之罪", "1号号作为围绕自身欲望和生存模式的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。Sp代表着自保的本能，追求完美的愤怒的能量与审视自身的自保的本能结合后，当其在自己心目中的形象太不完美时，他的愤怒常常会转化成一种持续的自我改进的能量，就好像上了瘾一样。并且他的愤怒，会隐藏在与其愤怒和埋怨截然相反的彬彬有礼的善行和乐于助人的态度背后。换言之，他将愤怒转换成了善意。"]
    }
    if (type == 'So2') {
    ...
    if (type == 'So3') {
        return ["关键词:声誉", "虚荣之罪", "3号是与自身的围绕价值评价的心区隔离的类型，也就是不在乎自己内心对自己的评价，而极度迎合讨好他人的评价的类型，为此其在社会竞争中往往会不择手段的去竞争获得优胜，获取虚名，因此其被定义为七原罪之外的虚荣。 "]
    }
    if (type == 'Sx3') {
        return ["关键词:吸引力", "虚荣之罪", "3号是与自身的围绕价值评价的心区隔离的类型，也就是不在乎自己内心对自己的评价，而极度迎合讨好他人的评价的类型，为此其在社会竞争中往往会不择手段的去竞争获得优胜，获取虚名，因此其被定义为七原罪之外的虚荣。"]
    }
    if (type == 'Sp3') {
        return ["关键词:安全感", "虚荣之罪", "3号是与自身的围绕价值评价的心区隔离的类型，也就是不在乎自己内心对自己的评价，而极度迎合讨好他人的评价的类型，为此其在社会竞争中往往会不择手段的去竞争获得优胜，获取虚名，因此其被定义为七原罪之外的虚荣。sp的自保本能与3的虚荣相冲突的，所以sp3是反虚荣的反3，虽然其内心渴望虚荣与名誉，但是其表面上非常拒绝虚荣低调行事，希望做一个大家认可的好人。"]
    }
    if (type == 'So4') {
        return ["关键词:羞耻", "嫉妒之罪", "4号作为围绕价值评价的心区能量缺乏的类型，其核心是认为自己不如他人，所以4号的嫉妒是与他人的对比中感受到自身价值的缺失，从而容易陷入痛苦之中，为保护自身的情感远离他人。"]
    }
    if (type == 'Sx4') {
        return ["关键词:仇恨", "嫉妒之罪", "4号作为围绕价值评价的心区能量缺乏的类型，其核心是认为自己不如他人，所以4号的嫉妒是与他人的对比中感受到自身价值的缺失，从而容易陷入痛苦之中，为保护自身的情感远离他人。不过由于4号偏向脑区，激情的Sx与脑区的理性相冲突，于是Sx4成了极度扭曲的拒绝嫉妒的反4，虽然他们深层意识里认为自己不如他人，但他们拒绝这一点，所以喜欢摆出远在他人之上的态度，并对某一类人充满仇恨,蔑视普通的日常生活。"]
    }
    if (type == 'Sp4') {
        return ["关键词:坚韧", "嫉妒之罪", "4号作为围绕价值评价的心区能量缺乏的类型，其核心是认为自己不如他人，所以4号的嫉妒是与他人的对比中感受到自身价值的缺失，从而容易陷入痛苦之中，为保护自身的情感远离他人。Sp的自保本能与心区冲突，虽然4号都是痛苦的，但是Sp4是抗拒痛苦最坚韧的4号，因为自保本能要求4号必须学会抗拒克服痛苦才能保护自己的生存，这甚至可能导致部分极端的Sp4享受痛苦带来的快感。"]
    }
    if (type == 'So5') {
        return ["关键词:图腾", "贪婪之罪", "5号作为围绕思维和安全需求的脑区能量过剩的类型，非常容易沉浸到思维世界之中，所以5号的贪婪指的是5号容易贪婪的汲取某一领域的事物提升自己的思维和能力以应对可能潜在的危险与安全焦虑，例如贪婪的汲取时间，知识，信息等，并且可能为此不惜牺牲其他方面的需求，节衣缩食过着低欲望的远离他人的简朴生活，不惜代价的追求某一件事物才是真正的贪婪。5号是实质上最为理性的类型，但5号的思考往往不会基于主流价值的独立思考，所以看起来往往是魔怔且容易被认为是非理性的。"]
    }
    if (type == 'Sx5') {
        return ["关键词:秘密", "贪婪之罪", "5号作为围绕思维和安全需求的脑区能量过剩的类型，非常容易沉浸到思维世界之中，所以5号的贪婪指的是5号容易贪婪的汲取某一领域的事物提升自己的思维和能力以应对可能潜在的危险与安全焦虑，例如贪婪的汲取时间，知识，信息等，并且可能为此不惜牺牲其他方面的需求，节衣缩食过着低欲望的远离他人的简朴生活，不惜代价的追求某一件事物才是真正的贪婪。5号是实质上最为理性的类型，但5号的思考往往不会基于主流价值的独立思考，所以看起来往往是魔怔且容易被认为是非理性的。不过由于Sx与脑区冲突，所以Sx5是反5，其并非像一般的5号那样因为贪婪而退缩，Sx渴望着激烈深入的体验，尽管拒绝远离他人，但内心深处渴望着一个极度理想的伴侣"]
    }
    if (type == 'Sp5') {
        return ["关键词:避难所", "贪婪之罪", "5号作为围绕思维和安全需求的脑区能量过剩的类型，非常容易沉浸到思维世界之中，所以5号的贪婪指的是5号容易贪婪的汲取某一领域的事物提升自己的思维和能力以应对可能潜在的危险与安全焦虑，例如贪婪的汲取时间，知识，信息等，并且可能为此不惜牺牲其他方面的需求，节衣缩食过着低欲望的远离他人的简朴生活，不惜代价的追求某一件事物才是真正的贪婪。5号是实质上最为理性的类型，但5号的思考往往不会基于主流价值的独立思考，所以看起来往往是魔怔且容易被认为是非理性的。"]
    }
    if (type == 'So6') {
        return ["关键词:责任", "恐惧之罪", "6号作为围绕思维和安全需求的脑区隔离的类型，虽然有着丰富的思考，但与自己的脑区隔离，很难真正做到自己的思考，以基于某些前人或他人的理论或说法来进行思考，恐惧自身是错误的是邪恶的，希望确信自己是正义且正确的，往往他们会捍卫着主流的价值观或说法，因此容易被认为是非常理性的类型被误认为5号，他们内心有着捍卫他们所认可的价值观的激烈的情绪，又容易被误认为4号或8号，但548都是黑暗类型，而6号充满对光明与正义的追求，因为其恐惧黑暗，恐惧邪恶，恐惧错误，恐惧一切不正确的东西想通过依附于某一权威的羽翼之下得到保护放弃自身的思考来应对安全感的焦虑，所以其是七原罪之外衍生的恐惧。"]
    }
    if (type == 'Sx6') {
        return ["关键词:力量", "恐惧之罪", "6号作为围绕思维和安全需求的脑区隔离的类型，虽然有着丰富的思考，但与自己的脑区隔离，很难真正做到自己的思考，以基于某些前人或他人的理论或说法来进行思考，恐惧自身是错误的是邪恶的，希望确信自己是正义且正确的，往往他们会捍卫着主流的价值观或说法，因此容易被认为是非常理性的类型被误认为5号，他们内心有着捍卫他们所认可的价值观的激烈的情绪，又容易被误认为4号或8号，但548都是黑暗类型，而6号充满对光明与正义的追求，因为其恐惧黑暗，恐惧邪恶，恐惧错误，恐惧一切不正确的东西，想通过依附于某一权威的羽翼之下得到保护放弃自身的思考来应对安全感的焦虑，所以其是七原罪之外衍生的恐惧。Sx与脑区能量相冲突，形成了作为反6反恐惧的Sx6，他们往往不愿意承认自己恐惧，为此故意去从事英雄般的事业，虽然这看上去可能像8，但8是拥有真正的勇敢的内心，而Sx6的内心仍然是非常恐惧的，所以其非常渴望力量来战胜恐惧。"]
    }
    if (type == 'Sp6') {
        return ["关键词:温暖", "恐惧之罪", "6号作为围绕思维和安全需求的脑区隔离的类型，虽然有着丰富的思考，但与自己的脑区隔离，很难真正做到自己的思考，以基于某些前人或他人的理论或说法来进行思考，恐惧自身是错误的是邪恶的，希望确信自己是正义且正确的，往往他们会捍卫着主流的价值观或说法，因此容易被认为是非常理性的类型被误认为5号，他们内心有着捍卫他们所认可的价值观的激烈的情绪，又容易被误认为4号或8号，但548都是黑暗类型，而6号充满对光明与正义的追求，因为其恐惧黑暗，恐惧邪恶，恐惧错误，恐惧一切不正确的东西，想通过依附于某一权威的羽翼之下得到保护放弃自身的思考来应对安全感的焦虑，所以其是七原罪之外衍生的恐惧。"]
    }
    if (type == 'So7') {
        return ["关键词:牺牲", "暴食之罪", "7号作为围绕思维和安全需求的脑区能量缺乏的类型，总是容易忽略安全感上的焦虑，狼吞虎咽般的追求着获取自身独特的愉悦，因此被赋予了七原罪之中的暴食。"]
    }
    if (type == 'Sx7') {
        return ["关键词:易受暗示", "暴食之罪", "7号作为围绕思维和安全需求的脑区能量缺乏的类型，总是容易忽略安全感上的焦虑，狼吞虎咽般的追求着获取自身独特的愉悦，因此被赋予了七原罪之中的暴食。"]
    }
    if (type == 'Sp7') {
        return ["关键词:家庭", "暴食之罪", "7号作为围绕思维和安全需求的脑区能量缺乏的类型，总是容易忽略安全感上的焦虑，狼吞虎咽般的追求着获取自身独特的愉悦，因此被赋予了七原罪之中的暴食。"]
    }
    if (type == 'So8') {
        return ["关键词:同盟", "纵欲之罪", "8号作为围绕自身欲望和生存模式的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。"]
    }
    if (type == 'Sx8') {
        return ["关键词:占有欲", "纵欲之罪", "8号作为围绕自身欲望和生存模式的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。"]
    }
    if (type == 'Sp8') {
        return ["关键词:满足感", "纵欲之罪", "8号作为围绕自身欲望和生存模式的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。"]
    }
    if (type == 'So9') {
        return ["关键词:参与/归属", "怠惰之罪", "9号作为围绕自身欲望和生存模式的腹区能量隔离的类型，可能会看似有着很强烈的理想的表现，实则只是从他人那里借来的理想，9号在灵性上是迟钝的，可能日复一日的做着相同的事不求改变，虽然他们可能会不求回报的服务于他人，但这根本上是一种灵性上的怠惰，因此被赋予了七原罪的怠惰之名。"]
    }
    if (type == 'Sx9') {
        return ["关键词:共生", "怠惰之罪", "9号作为围绕自身欲望和生存模式的腹区能量隔离的类型，可能会看似有着很强烈的理想的表现，实则只是从他人那里借来的理想，9号在灵性上是迟钝的，可能日复一日的做着相同的事不求改变，虽然他们可能会不求回报的服务于他人，但这根本上是一种灵性上的怠惰，因此被赋予了七原罪的怠惰之名。"]
    }
    if (type == 'Sp9') {
        return ["关键词:食欲", "怠惰之罪", "9号作为围绕自身欲望和生存模式的腹区能量隔离的类型，可能会看似有着很强烈的理想的表现，实则只是从他人那里借来的理想，9号在灵性上是迟钝的，可能日复一日的做着相同的事不求改变，虽然他们可能会不求回报的服务于他人，但这根本上是一种灵性上的怠惰，因此被赋予了七原罪的怠惰之名。"]
    }
    return [" ", " ", " "]
}
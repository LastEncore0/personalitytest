function TestInstinctsq(num) {
    ...
    let q_list = [
        ...
        '我渴望获得社会认可，所以我对不同的人经常会投其所好，采取不同的面目，以获得他们的认可','我总是自责，带着自我厌恶的倾向与别人比较，为自己不如别人而痛苦',
        '我寻求超凡价值，追寻理想图腾吗，并因此间接的蔑视了凡人和普通生活','我内心有一条明确的界限来区分哪些人是好的，哪些人是坏的',
...
function TestInstinctsa(num) {
    ...
    if (num == 2) {
        result = [
            { text: "立下契约获得永久的生命，不过作为契约的条件你的命运只能看着朋友家人乃至爱人接连死去，难以进入新生代的圈子，最终孤独但自由的永生", type: [0, "Sp"], value: 20, color: "Instincts_answer" },
            { text: "立下契约获得可以对包括所以社会上流阶层在内的所有人施加精神影响，让他们都爱你尊重你愿意帮助提拔你，不过作为契约的条件你将因为不断地去应酬几乎没有个人时间，并且所有人都对你戴上虚假的面具，一生也难以寻获真正爱你的人", type: [0, "So"], value: 20, color: "Instincts_answer" },
            { text: "立下契约获得强大的以一敌万的战斗能力，被各方势力争相拉拢，虽然可以选择为你所理想的人或势力效忠，并去惩罚你所憎恨的人或势力，不过作为契约的条件必须不断的去战斗，只能接受在某次战斗中被杀死的命运", type: [0, "Sx"], value: 20, color: "Instincts_answer" },
        ]
    }
    if (num > 2 && num < 12) {

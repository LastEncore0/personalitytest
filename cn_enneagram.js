...
function getetext(type) {
    if (type == 'So1') {
        return ["关键词:不适感", "憤怒之罪", "1号的侧翼是9和1，所以可能会表现出9或1表面特征，如果表现出9的特征过于明显则称为1w9,同理，2的特征过于明显则称为1w2，1号的整合解离方向是7和4，所以1号可能表现出向4和7变化的特征。1号号作为围绕自身欲望和生存模式的腹区能量缺乏的类型，会为了服从自身所认同的规则或信条来压抑自身的欲望，纠正自身的错误，因此其有着一种愤怒作为内心的驱动力量来纠正其所认为错误的事情。So1即1号社群型认为自己已经达到完美状态，所以经常会采取一种完美无可挑剔的状态，并且认为【我是对的，你是错的】，不会愿意去适应对方的做法和腔调。"]
    }
    if (type == 'Sx1') {
    ...
    if (type == 'So8') {
        return ["关键词:同盟", "纵欲之罪", "8号的侧翼是7和9，所以可能会表现出7或9的表面特征，如果表现出7的特征过于明显则称为8w7,同理，9的特征过于明显则称为8w9，8号的整合解离方向是5和2，所以8号可能表现出向5和1变化的特征。8号作为围绕自身欲望和生存模式的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。8号社群型是一种叛逆者，他们愤世嫉俗，简单粗暴，坚韧而又粗鲁，友谊和同盟是他们的核心议题，与朋友同生共死打倒强权共赴胜利是他们最为渴望的事情。"]
    }
    if (type == 'Sx8') {
        return ["关键词:占有欲", "纵欲之罪", "8号的侧翼是7和9，所以可能会表现出7或9的表面特征，如果表现出7的特征过于明显则称为8w7,同理，9的特征过于明显则称为8w9，8号的整合解离方向是5和2，所以8号可能表现出向5和1变化的特征。8号作为围绕自身欲望和生存模式的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。Sx8即8号性本能型是所有类型中最为叛逆的最为反社会的类型，他们有着极强的占有欲和吸引力，这种占有欲并非对某种物品，而是对他人的占有欲，对场面的占有欲，渴望把整个场面的注意力都吸引到自己身上来。"]
    }
    if (type == 'Sp8') {
        return ["关键词:满足感", "纵欲之罪", "8号的侧翼是7和9，所以可能会表现出7或9的表面特征，如果表现出7的特征过于明显则称为8w7,同理，9的特征过于明显则称为8w9，8号的整合解离方向是5和2，所以8号可能表现出向5和1变化的特征。8号作为围绕自身欲望和生存模式的腹区能量过剩的类型，有着很强的欲望，这种欲望会促使他们去破坏和无视社会规则，其与1号的区别就在于1号是秩序的守护者或建立者，而其是秩序的破坏者，因此被赋予七原罪的纵欲。Sp8即8号自保型，是所有8中最会隐藏自己散发出的反社会气息，他们是最能在历史剧变中生存下来的类型，他们很容易认同【善良和良好的意图根本不存在】，他们会像社会主义者一样向他人慷慨的提供保护，但真正目的是借此控制和奴役他人，使他人无法威胁到他们自身。"]
    }
    if (type == 'So9') {

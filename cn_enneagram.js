...
function getetext(type) {
    ...
    if (type == 'So5') {
        return ["关键词:图腾","贪婪之罪","5号的贪婪指的是5号专注于某一领域，例如时间，知识，信息等，可能为此牺牲其他方面的需求，节衣缩食过着低欲望的简朴生活。"]
    }
    if (type == 'Sx5') {
        return ["关键词:秘密","贪婪之罪","5号的贪婪指的是5号专注于某一领域，例如时间，知识，信息等，可能为此牺牲其他方面的需求，节衣缩食过着低欲望的简朴生活。"]
    }
    if (type == 'Sp5') {
        return ["关键词:避难所","贪婪之罪","5号的贪婪指的是5号专注于某一领域，例如时间，知识，信息等，可能为此牺牲其他方面的需求，节衣缩食过着低欲望的简朴生活。"]
    }
    if (type == 'So6') {
        return ["关键词:责任","恐惧之罪"," "]
    }
